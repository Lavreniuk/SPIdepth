...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        opt.backbone = 'convnextv2_huge.fcmae_ft_in22k_in1k_384'
        if opt.backbone in ["resnet", "resnet_lite"]:
            ...
            encoder = networks.Unet(pretrained=(not opt.load_pretrained_model), backbone=opt.backbone, in_channels=3, num_classes=32, decoder_channels=opt.dec_channels)
